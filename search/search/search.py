...
def depthFirstSearch(problem):
    ...
    frontier.push((startState, [])) #(state, path)
...
def uniformCostSearch(problem):
    ...
    startState = problem.getStartState()
    frontier.push((startState, [], 0), 0) #(state, path, cost)
    
    exploredCost = {}
    exploredCost[startState] = 0
    ...
    while not frontier.isEmpty():
        ...
        if state not in visited:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                ...
                if successor not in exploredCost or newCost < exploredCost[successor]:
                    exploredCost[successor] = newCost
                    newPath = path + [action]
...
#     frontier = util.PriorityQueue()
#     startState = problem.getStartState()
#     frontier.push((startState, []), euclideanHeuristic(startState, problem))
...
#                 if successor not in visited:
#                     newPath = path + [action]
#                     cost = euclideanHeuristic(successor, problem)
#                     frontier.push((successor, newPath), cost)
        ...
        if current_state not in visited:
            ...
            for successor, action, cost in problem.getSuccessors(current_state):
                if successor not in visited:
                    ...
                    frontier.push((successor, new_path), heuristic(successor, problem))
